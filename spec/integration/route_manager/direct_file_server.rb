...
describe Puppet::RouteManager::DirectFileServer, " when interacting with the filesystem and the model" do
    before do
        ...
        @terminus = Puppet::RouteManager::FileContent::File.new
    ...
    it "should return an instance of the model" do
        ...
        @terminus.find(@terminus.router.request(:find, "file://host#{@filepath}")).should be_instance_of(Puppet::FileServing::Content)
    end
    ...
    it "should return an instance capable of returning its content" do
        ...
        instance = @terminus.find(@terminus.router.request(:find, "file://host#{@filepath}"))
...
describe Puppet::RouteManager::DirectFileServer, " when interacting with FileServing::Fileset and the model" do
    before do
        ...
        @request = @terminus.router.request(:search, "file:///%s" % @path, :recurse => true)
    end
