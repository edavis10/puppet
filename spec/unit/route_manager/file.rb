...
describe Puppet::RouteManager::File do
    ...
    describe Puppet::RouteManager::File, " when finding files" do
    ...
    describe Puppet::RouteManager::File, " when saving files" do
        before do
            @content = "my content"
    ...
    describe Puppet::RouteManager::File, " when removing files" do
