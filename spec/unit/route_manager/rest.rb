...
describe Puppet::RouteManager::REST do
    ...
    it "should include the v1 REST API module" do
        Puppet::RouteManager::REST.ancestors.should be_include(Puppet::Network::HTTP::API::V1)
    end
    ...
    describe "when creating an HTTP client" do
        ...
        it "should use the class's server and port if the router request provides neither" do
        ...
        it "should use the server from the router request if one is present" do
        ...
        it "should use the port from the router request if one is present" do
    ...
    describe "when doing a find" do
        before :each do
            ...
            @request = Puppet::RouteManager::Request.new(:foo, :find, "foo bar")
        end
        ...
        it "should use the URI generated by the Handler module" do
            @searcher.expects(:router2uri).with(@request).returns "/my/uri"
    ...
    describe "when doing a search" do
        before :each do
            ...
            @request = Puppet::RouteManager::Request.new(:foo, :search, "foo bar")
        end
        ...
        it "should use the URI generated by the Handler module" do
            @searcher.expects(:router2uri).with(@request).returns "/mys/uri"
    ...
    describe "when doing a destroy" do
        before :each do
            ...
            @request = Puppet::RouteManager::Request.new(:foo, :destroy, "foo bar")
        end
    ...
    describe "when doing a save" do
        before :each do
            ...
            @request = Puppet::RouteManager::Request.new(:foo, :save, "foo bar")
