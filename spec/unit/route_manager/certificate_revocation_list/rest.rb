...
require 'puppet/route_manager/certificate_revocation_list/rest'
...
describe Puppet::SSL::CertificateRevocationList::Rest do
    ...
    it "should be a sublcass of Puppet::RouteManager::REST" do
        Puppet::SSL::CertificateRevocationList::Rest.superclass.should equal(Puppet::RouteManager::REST)
    end
