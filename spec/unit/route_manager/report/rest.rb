...
require 'puppet/route_manager/report/rest'

describe Puppet::Transaction::Report::Rest do
    it "should be a subclass of Puppet::RouteManager::REST" do
        Puppet::Transaction::Report::Rest.superclass.should equal(Puppet::RouteManager::REST)
    end
