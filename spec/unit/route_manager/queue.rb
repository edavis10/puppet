...
require 'puppet/route_manager/queue'

class Puppet::RouteManager::Queue::TestClient
end
...
describe Puppet::RouteManager::Queue do
    ...
    before :each do
        ...
        Puppet::Util::Queue.stubs(:queue_type_to_class).with(:test_client).returns(Puppet::RouteManager::Queue::TestClient)
    ...
    it 'should use the correct client type and queue' do
        ...
        @store.client.should be_an_instance_of(Puppet::RouteManager::Queue::TestClient)
    end
